...
public class ManagerSearchCarDatepicker extends DialogFragment implements DatePickerDialog.OnDateSetListener{
    @NonNull
    @Override
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ManagerSearchCarScreen activity = (ManagerSearchCarScreen) getActivity();
